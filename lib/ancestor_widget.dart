...
import 'datasource/repository/coin_repository_contract.dart';
...
class AncestorWidget extends InheritedWidget {
  ...
  // final CoinPageContract viewModel = CoinPageViewModel(
  //   coinService: CoinSearchService(
  //     coinRepository: CoinRepository(
  //       coinApi: CoinApiImplementation(
  //         adapter: NetworkImplementation(),
  //       ),
